...
ctx:close()
print(("test_real_encoder_attention_golden.lua: ok max_diff=%.9g dec_max_diff=%.9g cross_max_diff=%.9g dec_block_max_diff=%.9g decoder_max_diff=%.9g block_max_diff=%.9g logits_max_diff=%.9g forward_max_diff=%.9g encoder_max_diff=%.9g")
	:format(
