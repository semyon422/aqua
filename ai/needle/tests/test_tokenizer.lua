...
local reordered_tools_json =
'[{"parameters":{"type":"object","properties":{"rate":{"type":"number"}},"required":["rate"]},"name":"set_playback_rate"},{"parameters":{"type":"object","properties":{"mode":{"type":"string","enum":["save"]}},"required":["mode"]},"name":"capture_screenshot"}]'
...
local native_tools_json =
'[{"name":"set_playback_rate","parameters":{"rate":{"type":"number","required":true}}},{"name":"capture_screenshot","parameters":{"mode":{"type":"string","required":true,"enum":["save"]}}}]'
