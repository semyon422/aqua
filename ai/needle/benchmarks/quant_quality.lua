...
local tools_json =
'[{"name":"get_weather","parameters":{"location":{"type":"string"},"unit":{"type":"string"}}},{"name":"set_timer","parameters":{"minutes":{"type":"number"}}},{"name":"send_email","parameters":{"recipient":{"type":"string"},"body":{"type":"string"}}}]'
...
print(("summary_cases=%d matched=%d match_rate=%.2f worst_encoder_diff=%.9g worst_encoder_case=%s q8_projections=%d float_projections=%d q8_fallbacks=%d")
	:format(
		checked,
		matched,
