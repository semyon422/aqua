...
- [ ] Add Cactus-style blocked encoder attention for QK and softmax·V cache locality.
- [ ] Evaluate FP16 encoder scratch/QKV/context buffers after blocked attention is correct.
- [x] Cache q8 companion tensor pointers and common encoder tensor pointers at load time.
- [ ] Add persistent per-context execution plans for reusable scratch buffers and layout metadata.
