...
- [x] Cache q8 companion tensor pointers at load time.
...
6. **Persistent execution plans.** Cactus avoids repeated setup through graph-owned buffers and metadata. Needle now caches q8 companion tensor pointers at load time; it should eventually also cache scratch workspaces and layout decisions per context.
